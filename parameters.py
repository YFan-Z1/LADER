...
# model config
parser.add_argument("--model_name", help="model name", type=str, default='MSCI')
parser.add_argument("--lr", help="learning rate", type=float, default=5e-05)
parser.add_argument("--dataset", help="name of the dataset", type=str, default='ut-zap50k')
...
parser.add_argument("--train_batch_size", help="train batch size", default=1, type=int)
parser.add_argument("--eval_batch_size", help="eval batch size", default=2, type=int)
parser.add_argument("--num_workers", help="number of workers", default=4, type=int)
parser.add_argument("--yml_path", help="yml path", type=str, default='config/msci/ut-zap50k-modify.yml')
parser.add_argument("--clip_arch", help="clip path", type=str, default='clip_modules/ViT-L-14.pt')
parser.add_argument("--dataset_path", help="dataset path", type=str, default='data/ut-zap50k')
...
parser.add_argument("--gpu_index", help="gpu use", default=0, type=int)
...
parser.add_argument('--threshold_low', type=float, default=None, help="optional threshold")
parser.add_argument('--threshold_high', type=float, default=None, help="optional threshold")
